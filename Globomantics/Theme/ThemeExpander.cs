...
namespace Globomantics.Theme
{
    public class ThemeExpander : IViewLocationExpander
    {
        public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
        {
            ...
            {
                expandedLocations.Insert(
                    i,
                    viewLocations.ElementAt(i).Replace("/Views/", string.Format("Views/Themes/{0}/", activeTheme))
                );
            }
        ...
        public void PopulateValues(ViewLocationExpanderContext context)
        {
            ...
            context.Values["ACTIVE_THEME"] = appSettings.GetSection("AppSettings")["ActiveTheme"];
        }
    }
}
